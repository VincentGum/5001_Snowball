...
class q_unit():
    ...
    def get_env_feedback(self, stepcounter, A):
        ...
        if stepcounter == len(self.STATES) - 2:  # terminate
            ...
            if (0 <= self.REWARD_RULE[ins[0]][stepcounter]) & (self.REWARD_RULE[ins[0]][stepcounter] < 30):
                R += 10
            elif (30 <= self.REWARD_RULE[ins[0]][stepcounter]) & (self.REWARD_RULE[ins[0]][stepcounter] < 70):
                R += 2

            if (0 <= self.REWARD_RULE[ins[1]][stepcounter]) & (self.REWARD_RULE[ins[1]][stepcounter] < 30):
                R += 10
            elif (30 <= self.REWARD_RULE[ins[1]][stepcounter]) & (self.REWARD_RULE[ins[1]][stepcounter] < 70):
                R += 2

            if (0 <= self.REWARD_RULE[ins[2]][stepcounter]) & (self.REWARD_RULE[ins[2]][stepcounter] < 30):
                R += 10
            elif (30 <= self.REWARD_RULE[ins[2]][stepcounter]) & (self.REWARD_RULE[ins[2]][stepcounter] < 70):
                R += 2
        else:
